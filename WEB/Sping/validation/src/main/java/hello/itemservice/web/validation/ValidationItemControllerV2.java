...
public class ValidationItemControllerV2 {
    ...
    public String addItemV1(@ModelAttribute Item item,BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        // BindingResult는 바인딩하려는 @ModelAttribute 인자 바로 뒤에 써야한다. BindingResult로 담으면 따로 model에 안 넣어줘도 된다.
        ...
        if(item.getPrice()!=null && item.getQuantity()!=null){
            ...
            if(resultPrice<10000){
                bindingResult.addError(new ObjectError("item", "가격 * 수량의 합은 만원 이상이어야 합니다. 현재 값 : "+resultPrice));
            }
        }
    ...
    public String addItemV2(@ModelAttribute Item item,BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        ...
        if(item.getPrice()!=null && item.getQuantity()!=null){
            int resultPrice = item.getQuantity()*item.getPrice();
            if(resultPrice<10000){
                bindingResult.addError(new ObjectError("item",null,null, "가격 * 수량의 합은 만원 이상이어야 합니다. 현재 값 : "+resultPrice));
            }
        }
    ...
    public String addItemV4(@ModelAttribute Item item,BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        ...
        if(bindingResult.hasErrors()){  // 타입 오류 같이 컨트롤러 전에 문제가 생길경우
            return "validation/v2/addForm";
        }
